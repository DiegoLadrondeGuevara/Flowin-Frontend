...
useEffect(() => {
    ...
    if (state.canciones && state.canciones.length > 0) {
      ...
      const primeraCancion = cancionesBackend[0];
      if (primeraCancion) {
        setUrlActual(primeraCancion.url);
        setArtistas(primeraCancion.artistas.join(", "));
      }
